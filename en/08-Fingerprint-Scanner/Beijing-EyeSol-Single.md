...
| Item | Content |
|------|------|
| Device Type | Fingerprint Scanner (Single-Finger) |
| Brand | Beijing EyeSol Intelligent Technology |
...
> The single-finger scanner only supports individual finger position codes; combined codes (such as "12+13+14+15") are not supported.
